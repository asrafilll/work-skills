...
| **production-readiness-audit** | Principal Infrastructure Engineer mode: audits a repo for production readiness across backend, frontend, CI/CD, infra, security, and observability. Graded scorecard + severity-ranked findings + remediation plan; assessment only, no fixes. |
